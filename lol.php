...
echo "<html><head><title>403 Forbidden</title></head><body><center><h1>Forbidden</h1></center><hr><center>nginx</center><center>".$Eform."</center></body></html>";
exit;
}
...
echo "<html><head><title>404 Not Found</title></head><body><center><h1>404 Not Found</h1></center><hr><center>nginx</center><center>".$Eform."</center></body></html>";
exit;
}
}
}
